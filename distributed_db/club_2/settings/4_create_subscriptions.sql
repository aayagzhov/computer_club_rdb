-- Subscribe club2 to central and other clubs for master-master replication on clients table
-- and to central for maintenance_requests updates (bidirectional)

SELECT spock.sub_create(
    subscription_name := 'sub_from_central_to_club2_master_master',
...
SELECT spock.sub_create(
    subscription_name := 'sub_from_central_to_club2_maintenance',
    provider_dsn := 'host=central_db port=5432 user=admin password=password dbname=computer_club_rdb',
...
SELECT spock.sub_create(
    subscription_name := 'sub_from_club1_to_club2_master_master',
...
SELECT spock.sub_create(
    subscription_name := 'sub_from_club3_to_club2_master_master',
